  	...
  	<?php foreach($data as $row):?>
           ...
           <div class="IndivNCPSSpecial qncpsContent" id="<?php echo $row->csid;?>">
				<div class="qncpsContentBody">
					<div class="ncps_img" <?php echo $imageDivStyle;?>><img src="<?php echo $couponImage;?>" alt="quirk service coupon special">
					</div>
						...
						<div class="qncpsBottomHalf">
								...
								<span class="disclosure"><?php echo $disclaimerText;?></span>
										...
										<div class="qncpsCTAs">
											...
											<!-- <a class="qncpsPrintInfo ncps_btn_color"><span>Print</span></a>-->
