...
<script type="text/javascript" src="<?php echo  SITEURL;?>/assets/multicoupon.js?ver=1.1.9"></script>
</head>
<body>
      ...
      <nav>
        <ul>
         ...
         <?php if (Users::checkAcl("owner")):?>
          ...
          <?php endif;?>
          <li class="normal"><a class="submenu<?php if (Url::isPartSet(1, array('couponspecials', 'year', 'deal','updatemulticoupons'))) echo ' active';?>"><span>Coupon Specials</span></a>
            <ul>
