   ...
   <div class="row screen-50 tablet-50 phone-100">
    <div class="wojo divided card">
     ...
     <div class="item">
      ...
      <div class="item">
        <div class="intro"><?php echo Lang::$word->WSP_STOCK;?>: <input type="text" value="<?php echo $row->stock_id;?>" name="stock_id"></div>
        <div class="data"><strong><?php echo Lang::$word->WSP_TRIM_LEVEL;?></strong>:  <input type="text" value="<?php echo $row->trim_level;?>" name="trim_level"></div>
      </div>
      <div class="item">
      ...
      <div class="item">
      <div class="intro"><?php echo Lang::$word->WSP_TAGLINE;?>: <input type="text" value="<?php echo $row->tagline;?>" name="tagline"></div>
      </div>
      </div>
      </div>
      <div class="row screen-50 tablet-50 phone-100">
      ...
      <div class="content">
       ...
       <div class="data" id="leasePrice" ><strong>$ <?php echo Lang::$word->WSP_LEASE_PRICE;?>/Month</strong>: <input type="number" value="<?php echo $row->lease_price;?>" name="lease_price"></div>
        <div class="data" id="singlePayLeasePrice" ><strong>$ Single Pay Lease Price</strong>:  <input type="number" value="<?php echo $row->single_lease_price;?>" name="single_lease_price"></div>
      </div>
     <div class="item">
        <div class="intro">$ <?php echo Lang::$word->WSP_SAVE_UP_TO_AMOUNT;?>: <input type="number" value="<?php echo $row->save_up_to_amount;?>" name="save_up_to_amount"></div>
        <div class="data" id="leaseDownPayment" ><strong>$ <?php echo Lang::$word->WSP_LEASE_DOWN_PAYMENT;?></strong>: <input type="number" value="<?php echo $row->lease_extras;?>" name="lease_extras"></div>
        <div class="data" id="singlePayLeaseTerm"><strong>Single Pay Lease Lease Term/Months</strong>: <input type="number" value="<?php echo $row->single_lease_term;?>" name="single_lease_term"></div>
      </div>
      <div class="item">
        <div class="intro">$ <?php echo Lang::$word->WSP_BUYPRICE;?>:  <input type="number" value="<?php echo $row->buy_price;?>" name="buy_price"></div>
       <div class="data" id="leaseTerm" ><strong><?php echo Lang::$word->WSP_LEASE_TERM;?></strong>: <input type="number" value="<?php echo $row->lease_term;?>" name="lease_term"></div>
        <div class="data" id="singlePayLeaseMiles"><strong>Single Pay Lease Lease Miles</strong>:  <input type="number" value="<?php echo $row->single_lease_miles;?>" name="single_lease_miles"></div>
      </div>
      <div class="item">
         <div class="intro">$ <?php echo Lang::$word->WSP_MSRP_MSRP;?>: <input type="number" value="<?php echo $row->msrp;?>" name="msrp"></div>
         <div class="data">$ <strong><?php echo Lang::$word->WSP_ZERO_DOWN_LEASE_PRICE;?></strong>:<input type="number" step="0.01" value="<?php echo $row->zero_down_lease_price;?>" name="zero_down_lease_price"></div>
        <div class="data"><strong><?php echo Lang::$word->WSP_ZERO_DOWN_LEASE_TERM;?></strong>:<input type="number" step="0.01" value="<?php echo $row->zero_down_lease_term;?>" name="zero_down_lease_term"></div>
      </div>
      <div class="item">
      <div class="intro">$ <?php echo Lang::$word->WSP_AVAILABLE_APR;?>: <input type="number" step="0.01" value="<?php echo $row->available_apr;?>" name="available_apr"></div>
      <div class="data"><strong><?php echo Lang::$word->WSP_APR_TEXT;?></strong>:<input type="text" value="<?php echo $row->apr_text;?>" name="apr_text"></div>
      </div>
      </div>
      </div>
      <div class="row screen-50 tablet-50 phone-100">
      ...
      <div class="addmore wojo form segment" style="display: none">
			  ...
			  <div class="footer">
			    <div class="wojo tabular segment">
			      ...
			      <div class="wojo cell right"> <?php echo Lang::$word->TOTAL.': '.$pager->items_total;?> </div>
			    </div>
			  </div>
			</div>
		</div>
    ...
    <div class="wojo divided card">
      <div class="header">
      <div class="content">
       <a href="">Vehicle Special Disclaimer/Url Content</a> 
      </div>
      </div>
       <div class="item">
       <div class="intro"><?php echo Lang::$word->WSP_DISCLAIMER_TEXT;?><i class="icon pin" data-content="<?php echo Lang::$word->WSP_DO_NOT_USE_DOUBLE_QUOTES;?>"></i>: <textarea name="disclaimer_text"><?php echo $row->disclaimer_text;?></textarea></div>
      </div>
     <div class="item">
        <div class="intro"><?php echo Lang::$word->WSP_VEHICLE_IMAGE_Url;?>: <input type="text" value="<?php echo $row->vehicle_image;?>" name="vehicle_image"></div>
       </div>
      <div class="item">
        <div class="intro"><?php echo Lang::$word->WSP_INVENTORY_URL;?>:   <input type="text"  value="<?php echo $row->alt_link_url;?>" name="alt_link_url"></div>
      </div>
      <div class="item">
         <div class="intro"><?php echo Lang::$word->WSP_NCS_ORDERING;?>: <input class="wojo range slider" type="range" min="1" max="20" step="1" name="ordering" value="<?php echo $row->ordering;?>"></div>
       </div>
       <div class="item">
     ...
     <div id="general" class="wojo tab item">
      <div class="four fields">
        <div class="field">
          ...
          <select name="location" type="hidden">
    ...
    <div id="disclaimer" class="wojo tab item">
      ...
      <div class="field">
        ...
        <textarea name="disclaimer_text" class="bodypost"><?php echo $row->disclaimer_text;?></textarea>
      </div>
      <div class="field">
       ...
       <textarea name="zero_down_lease_disclaimer_text" class="bodypost"><?php echo $row->zero_down_lease_disclaimer_text;?></textarea>
      </div>
      </div>
      </div>
