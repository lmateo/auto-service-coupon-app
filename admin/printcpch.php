...
<link rel="stylesheet" type="text/css" href="<?php echo Url::adminUrl ( "assets", false, "css/ncps_coupon_print.css" )?>" />
...
$(document).ready(function() {
	...
	$(window).on('load', function() {
	   ...
	   var ADMINURL = 'http://qncps.quirkspecials.com/admin'
	        $.ajax({
	            type: "get",
	            url: ADMINURL + '/helper.php',
	            data: {
	            	loadCouponSpecialsPreviewPrint: 1,
	            	id: id   
	            },
