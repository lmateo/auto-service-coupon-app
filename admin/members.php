...
<div id="listwrap">
  <?php foreach($data as $row):?>
  <div class="row">
    <div class="wojo coupon segment"> 
    <div>
      <div class="header">
        <div class="wojo top right attached label rounded small grid image"><img src="http://newcars.quirkspecials.com/wp-content/uploads/2015/09/cdjrimg-300x39.png" alt="" height="30" width="30" class="wojo grid image"></div>
        <div class="content">OIL CHANGE & TIRE ROTATION SPECIAL
        </div>
        </div>
        </div>
        <br>
    	<br>
          ...
          <div class="wojo label">Expires: <span class="detail"><?php echo $row->year;?></span></div>
           </div>
       ...
       <a href="<?php echo UPLOADURL . 'listings/' . $row->thumb?>" data-title="<?php echo $row->title;?>" data-lightbox-gallery="true" data-lightbox="true"><img src="<?php echo UPLOADURL . 'listings/thumbs/' . $row->thumb;?>" alt="" class="wojo grid image"></a>
