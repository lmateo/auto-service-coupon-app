  ...
  <form method="post" id="wojo_form" name="wojo_form">
    ...
    <div class="field">
      ...
      <div class="field">
        ...
        <div class="wojo labeled icon input">
          <input type="text" value="<?php echo $row->leadsemail;?>" name="leadsemail" required>
          <div class="wojo corner label"> <i class="icon asterisk"></i> </div>
        </div>
      </div>
    </div>
...
<div class="wojo tertiary segment">
  <div class="header clearfix"><span><?php echo Lang::$word->LOC_SUB;?></span> </div>
</div>
<?php if(!$data):?>
...
<div class="columns gutters">
  ...
  <div class="row screen-33 tablet-50 phone-100">
    <div class="wojo divided card">
      ...
      <div class="item">
        <div class="intro">View Coupon Specials:</div>
        <div class="data"><a href="<?php echo Url::adminUrl("couponspecials", false, false,"?id=" . $row->store_id);?>"><img src="<?php echo ($row->logo2) ? $row->logo2 : "blank.png";?>" height="90" width="90" alt=""></a></div>
      </div>
