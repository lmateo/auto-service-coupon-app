  ...
  <?php if(!$sdata):?>
    ...
    <table class="wojo sortable table">
      ...
      <tbody id="listtable">
        ...
        $cpWidget = "<!-- load the widget code --><script type='text/javascript'>var ncpsDealerid={ncpsid: '$cpWidgetId'};</script><script src='http://ncps.quirkspecials.com/ncps_coupon_widget/ncpswidget/ncpswidget.min.js?ver=3.3.2'></script><div id='ncpswidget'></div>";
