...
<?php
  ...
  case "deleteDealtype":
  	...
  	/* == Delete Coupontype == */
  	case "deleteCoupontype":
  		$res = $db->delete(Content::cptypeTable, array('id' => Filter::$id));
  		Message::msgReply($res, 'success', str_replace("[NAME]", $title, Lang::$word->CPTYPE_DEL_OK));
  ...
  case "deleteWebspecials":
    ...
    Message::msgReply($res, 'success', str_replace("[NAME]", $title, Lang::$word->LST_DEL_OK));
  	...
  	/* == Delete Couponspecials == */
  	case "deleteCouponspecials":
  		$res = $db->delete(cSpecials::csTable, array('id' => Filter::$id));
  		Message::msgReply($res, 'success', str_replace("[NAME]", $title, Lang::$word->LST_DEL_OK));
  		break;
...
/* == Process Auto Save Web Specials == */
	case "processWebspecialsUpdate_autosave":
		$wSpecials->processWebspecialsUpdate_autosave();
		break;
		
		
 /* == Process Coupon Specials == */
		case "processCouponspecials":
			$cSpecials->processCouponspecials();
			break;
		
	/* == Process Dublicate Coupon Specials == */
		case "processCouponspecialsDubs":
			$cSpecials->processCouponspecialsDubs();
			break;
		
	/* == Process Auto Save Coupon Specials == */
		case "processCouponspecialsUpdate_autosave":
			$cSpecials->processCouponspecialsUpdate_autosave();
			break;
			
	/* == Process Update Multi Service Coupon Specials == */
		case "processMultiServiceCouponUpdate":
			$cSpecials->processMultiServiceCouponUpdate();
			break;
	
	/* == Process ADDED Multi Service Coupon Specials == */
		case "processMultiServiceCouponAdded":
