...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo SITEURL;?>/assets/favicons/favicon.ico">
<script type="text/javascript">
var SITEURL = "<?php echo SITEURL; ?>";
var ADMINURL = "<?php echo ADMINURL; ?>";
</script>
<link href="<?php echo ADMINURL . '/assets/cache/' . Cache::cssCache(array('css/base.css','css/button.css','css/image.css','css/icon.css','css/flags.css','css/breadcrumb.css','css/tooltip.css', 'css/ncps_coupon_print.css','css/ncps-coupons.css','css/form-new.css','css/input.css','css/table.css','css/label.css','css/segment.css','css/message.css','css/divider.css','css/dropdown.css','css/list.css','css/header.css','css/menu.css','css/datepicker.css','css/editor.css','css/feed.css','css/utility.css','css/style.css'),'css');?>" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<?php echo  SITEURL;?>/assets/multicoupon.js?ver=1.2.9"></script>
</head>
<body>
      ...
      <nav>
        ...
        <?php if (Users::checkAcl("owner","admin")):?>
         ...
         <?php if (Users::checkAcl("owner")):?>
          ...
          <?php endif;?>
          <li class="normal"><a class="submenu<?php if (Url::isPartSet(1, array('couponspecials', 'year', 'deal','updatemulticoupons','couponWidgetScripts'))) echo ' active';?>"><span>Coupon Specials</span></a>
            <ul>
              <li><a <?php if (in_array("couponspecials", $core->_url)) echo ' class="active"';?> href="<?php echo Url::adminUrl("couponspecials");?>">Manage Coupon Specials</a></li>
              <li><a <?php if (in_array("updatemulticoupons", $core->_url)) echo ' class="active"';?> href="<?php echo Url::adminUrl("couponspecials","updatemulticoupons");?>">Manage Multiple Coupon Specials</a></li>
              ...
              <?php endif;?>
              <?php if(Auth::hasPrivileges('manage_coupontype')):?>
              <li><a <?php if (in_array("coupontype", $core->_url)) echo ' class="active"';?> href="<?php echo Url::adminUrl("coupontype");?>"><?php echo Lang::$word->DEAL_TITLE;?></a></li>
              <?php endif;?>
              <li><a <?php if (in_array("couponWidgetScripts", $core->_url)) echo ' class="active"';?> href="<?php echo Url::adminUrl("couponspecials","couponWidgetScripts");?>">View Service Coupon Tag Scripts</a></li>
             </ul>
          </li>
           <?php if (Users::checkAcl("owner")):?>
