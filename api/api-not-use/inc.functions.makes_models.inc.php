...
$dbpass="(OTiJdM%.JUs";
$chandle = mysql_connect("localhost", $dbuser, $dbpass) or die("Connection Failure to Database" . mysql_error());
mysql_select_db("quirkspe_ncs", $chandle) or die ($dbname . " Database not found. User: " . $dbuser);
