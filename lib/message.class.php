<?php
   ...
   * @copyright 2014
   * @version $Id: message.class.php, v1.00 2014-10-20 18:20:24 gewa Exp $
   */
  ...
  class Message
  {
      ...
      {
          self::$showMsg = "<ol class=\"wojo list\">";
          foreach (self::$msgs as $msg) {
              self::$showMsg .= "<li>" . $msg . "</li>\n";
          }
          self::$showMsg .= "</ol>";
       ...
       * @return
       */
      public static function msgReplyws($data, $type, $id, $msg, $msg2 = false)
      {
      	$title = strtoupper($type);
      	if ($data) {
      		$json['type'] = $type;
      		$json['title'] = Lang::$word->$title;
      		$json['html'] = Content::getwebspecialspreview($id);
      		$json['message'] = $msg;
      	} else {
      		$json['type'] = 'alert';
      		$json['title'] = Lang::$word->ALERT;
