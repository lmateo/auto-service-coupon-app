<?php
  ...
  class Db extends PDO
  {
       ...
       * @return
       */
      public function getValueByCouponType($sTable = '', $aColumn, $coupon_type = '')
      {
      	if($row = $this->select($sTable, array($aColumn), array('name' => $coupon_type), 'LIMIT 1')->result()) {
      		return $row->$aColumn;
      	} else {
      		return false;
      	}
