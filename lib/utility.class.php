<?php
  ...
  class Utility
  {
       ...
       * @return
       */
      public static function loopOptionsvalue($array, $value, $selected = false)
      {
      	$html = '';
      	if (is_array($array)) {
      		foreach ($array as $row) {
      ...
      /**
       * Utility::changeCouponImg()
       *
       * @return
       */
      public static function changeCouponImg()
      {
      	$couponimg = "";
      	if (date("H") < 12) {
      		$couponimg .= "<img src='../uploads/multicouponimg/vehicle_one_car_service.png' alt=''>";
      	} else
      		if (date('H') > 11 && date("H") < 18) {
      			$couponimg .= "<img src='../uploads/multicouponimg/service_two_cars.jpg' alt=''>";
      		} else
      			if (date('H') > 17) {
      				$couponimg .= "<img src='../uploads/multicouponimg/vehicle_services.png' alt=''>";
      			}
      ...
      public static function ncps_strip_phone( $pnum ) {
      ...
      public static function ncps_fix_phone( $num ) {
      
      	$phone = self::ncps_strip_phone($num);
      ...
      public static function csv_to_array($filename, $delimiter=',', $enclosure='"', $escape = '\\')
      {
